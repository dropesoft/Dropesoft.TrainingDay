...
class Version20160305150025 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE dropesoft_trainingday_domain_model_trainingday (persistence_object_identifier VARCHAR(40) NOT NULL, trainigplan VARCHAR(40) DEFAULT NULL, day INT NOT NULL, week INT NOT NULL, period INT NOT NULL, description LONGTEXT DEFAULT NULL, executed TINYINT(1) DEFAULT '0', note VARCHAR(255) DEFAULT NULL, dateexecute DATETIME DEFAULT NULL, type INT NOT NULL, INDEX IDX_2071D0BD7002AD59 (trainigplan), PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET latin1");
		...
		$this->addSql("ALTER TABLE dropesoft_trainingday_domain_model_trainingday ADD CONSTRAINT FK_2071D0BD7002AD59 FOREIGN KEY (trainigplan) REFERENCES dropesoft_trainingday_domain_model_trainingplan (persistence_object_identifier)");
